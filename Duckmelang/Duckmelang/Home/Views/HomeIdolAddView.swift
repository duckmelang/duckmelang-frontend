...
class HomeIdolAddView: UIView {
    ...
    private lazy var idolAddTitle = Label(text: "", font: .aritaSemiBoldFont(ofSize: 18), color: .black)
    ...
    private func setupView(){
        [topStack, title, searchBar, searchIcon, idolAddCollectionView].forEach{addSubview($0)}
